package com.example.moviescomposed.movielist.data.repository

import android.net.http.HttpException
import android.os.Build
import androidx.annotation.RequiresExtension
import com.example.moviescomposed.movielist.data.local.movies.MovieDatabase
import com.example.moviescomposed.movielist.data.local.movies.MovieEntity
import com.example.moviescomposed.movielist.data.mappers.toMovie
import com.example.moviescomposed.movielist.data.mappers.toMovieEntity
import com.example.moviescomposed.movielist.data.remote.MovieApi
import com.example.moviescomposed.movielist.domain.model.Movie
import com.example.moviescomposed.movielist.domain.repository.IMoviesListRepository
